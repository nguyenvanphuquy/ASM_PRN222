...
public class EmbeddingModelsModel : PageModel
{
    private readonly IEmbeddingComparisonService _compare;
    private readonly ISubjectService _subjects;

    public EmbeddingModelsModel(IEmbeddingComparisonService compare, ISubjectService subjects)
    {
        _compare = compare;
        _subjects = subjects;
    }
    ...
    public EmbeddingComparisonResult? Result { get; private set; }
    ...
    public async Task OnGetAsync()
    {
        ...
        ViewData["TopbarTitle"] = "🧬 Benchmark Embedding Model";
